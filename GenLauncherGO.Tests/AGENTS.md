...
- After red, make the smallest production change, rerun the target to green, then run the relevant suite and repository
  gates. Report the red and green commands and outcomes, or why no test qualified, in the handoff.
