...
/// <summary>
///     Locates authored UI sources while excluding build output from source-contract scans.
/// </summary>
internal static class TestUiProjectSources
{
    ...
    private static DirectoryInfo FindProjectDirectory()
    {
        ...
        throw new InvalidOperationException(
            $"No GenLauncherGO.UI directory above '{AppContext.BaseDirectory}', so its sources cannot be scanned.");
    }
