...
{
    public static IServiceCollection AddGenLauncherGoInfrastructure(
        this IServiceCollection services,
        string applicationUpdateRepositoryUrl)
    {
        ArgumentNullException.ThrowIfNull(services);
        ArgumentException.ThrowIfNullOrWhiteSpace(applicationUpdateRepositoryUrl);
        ...
        services.AddSingleton<ILauncherApplicationUpdateService>(serviceProvider =>
            new VelopackLauncherApplicationUpdateService(
                ...
                applicationUpdateRepositoryUrl,
